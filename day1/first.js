...
const header1=react.createElement('h1',{fontSize:"30px",backgroundColor:"blue"},"hwllo coder");
const header2=react.createElement('h1',{fontSize:"40px",backgroundColor:"green"},"what up bro");
